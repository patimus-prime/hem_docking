...
print("Current pdb file location:", currentPDB)
...
# gonna be lazy and get the pdb code via the 
# INDEX of the string above, since should always just be 4
# characters...

currentPDB_string = str(currentPDB)
currentPDB_code = currentPDB_string[8:12]
#print("THIS IS THE PDB CODE:",currentPDB_code)

rc("write format mol2 0 ~/project/mol2_heme/heme-"+currentPDB_code+".mol2")
